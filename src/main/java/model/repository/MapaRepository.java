...
public class MapaRepository implements Serializable {
    ...
    public static void inicializar() {
        ...
        profExatas = new Professor("Gegê","Professor de exatas, certinho?", salaDeAula, Area.EXATAS, "/bgimages/gege.png");
        profEletronica = new Professor("Jonas", "Doscente do DTEC, não trema.", salaDeAula, Area.ELETRONICA, "/bgimages/jonas.png");
        profProgramacao = new Professor("Claúdia Lucia", "Uma mãe. Ensina a programar", salaDeAula, Area.PROGRAMACAO, "/bgimages/claudia-lucia.png");
